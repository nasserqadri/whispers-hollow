...
function i(e2, t2) {
  ...
  try {
    for (; (void 0 === t2 || t2-- > 0) && !(r2 = a2.next()).done; ) u2.push(r2.value);
  } catch (e3) {
    o2 = { error: e3 };
  } finally {
    try {
...
function l(e2, t2, n2) {
  if (n2 || 2 === arguments.length) for (var r2, o2 = 0, a2 = t2.length; o2 < a2; o2++) !r2 && o2 in t2 || (r2 || (r2 = Array.prototype.slice.call(t2, 0, o2)), r2[o2] = t2[o2]);
  return e2.concat(r2 || Array.prototype.slice.call(t2));
}
function s(e2, t2, n2, r2) {
  for (var o2 = [], s2 = 4; s2 < arguments.length; s2++) o2[s2 - 4] = arguments[s2];
  ...
  return a(this, void 0, void 0, function() {
    ...
    return u(this, function(x) {
      switch (x.label) {
        case 0:
          if (a2 = t2, o2) {
            for (i2 = 0, l2 = 1; l2 < t2.length; l2++) if (s2 = t2[l2 - 1], (f2 = t2[l2]).length > s2.length || "" === f2) {
              i2 = l2;
              break;
            }
